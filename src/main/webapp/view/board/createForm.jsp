      ...
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" novalidate action="/board/create" method="post">
          ...
          <div class="mb-3">
            ...
            <textarea name="content" class="form-control" id="contents" cols="30" rows="5" placeholder="내용을 입력해주세요"></textarea>
          </div>
          <br>
          <div class="row">
            <div class="col-md-6 mb-3">
              <button class="btn btn-secondary btn-block" formaction="/board/create" type="submit">게시물 등록하기</button>
            </div>
            <div class="col-md-6 mb-3">
